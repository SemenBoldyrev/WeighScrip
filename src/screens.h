...
typedef struct _objects_t {
    ...
    lv_obj_t *obj2__obj9;
    lv_obj_t *obj3;
    lv_obj_t *obj3__spiner_container;
    lv_obj_t *obj3__obj7;
    lv_obj_t *obj4;
    ...
    lv_obj_t *number_keyboard__obj5;
    lv_obj_t *number_keyboard__keyboard_text_area_1;
    lv_obj_t *number_keyboard__obj6;
    lv_obj_t *text_keyboard;
    lv_obj_t *text_keyboard__obj3;
    lv_obj_t *text_keyboard__keyboard_text_area;
    lv_obj_t *text_keyboard__obj4;
    lv_obj_t *obj7;
    lv_obj_t *obj7__spiner_container;
    lv_obj_t *obj7__obj7;
} objects_t;
